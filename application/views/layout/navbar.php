	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-right pullDown">
				...
				<a a data-toggle="tooltip" data-placement="left" title="Gerenciar perfil" href="profile.html"
				   class="dropdown-item has-icon"> <i class="far fa-user"></i> Profile

					<div class="dropdown-divider"></div>
					<a data-toggle="tooltip" data-placement="left" title="Encerrar a sessão"
					   href="<?php echo base_url('login/logout'); ?>" class="dropdown-item has-icon text-danger"> <i
