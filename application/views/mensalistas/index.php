									...
									<table class="table table-striped" id="table-1">
										...
										<?php foreach ($mensalistas as $mensalista): ?>
											...
											<tr>
												...
												<td>
													<?php echo $mensalista->mensalista_id; ?>
												</td>
												...
												<td>
													<?php echo $mensalista->mensalista_sobrenome; ?>
												</td>

												<td>
													<?php echo $mensalista->mensalista_email; ?>
												</td>

												<td>
													<?php echo $mensalista->mensalista_telefone_movel; ?>
												</td>

												<td>
													<?php echo($mensalista->mensalista_ativo == 1 ? '<span class="badge badge-success"><i class="fas fa-lock-open"></i>&nbsp;Sim</span>' : ' <span class="badge badge-danger"><i class="fas fa-solid fa-lock"></i>&nbsp;Não</span>'); ?>
												</td>
												...
												<td class="text-center">
													<a data-toggle="tooltip"
													   ...
													   href="<?php echo base_url($this->router->fetch_class() . '/core/' . $mensalista->mensalista_id); ?>"
													   class="btn btn-primary mr-2"><i class="fas fa-edit"></i></a>
													<a data-toggle="tooltip"
													   title="Excluír <?php echo $this->router->fetch_class(); ?>"
													   href="<?php echo base_url($this->router->fetch_class() . '/delete/' . $mensalista->mensalista_id); ?>"
