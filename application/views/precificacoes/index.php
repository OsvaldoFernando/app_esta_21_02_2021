									...
									<table class="table table-striped" id="table-1">
										...
										<?php foreach ($precificacoes as $categoria): ?>
											...
											<tr>
												...
												<td>
													<?php echo $categoria->precificacao_id; ?>
												</td>

												<td>
													<?php echo $categoria->precificacao_categoria; ?>
												</td>

												<td>
													<?php echo 'KZ &nbsp;'.$categoria->precificacao_valor_hora; ?>
												</td>

												<td>
													<?php echo 'KZ &nbsp;'.$categoria->precificacao_valor_mensalidade; ?>
												</td>

												<td class="text-center">
													<?php echo $categoria->precificacao_numero_vagas; ?>
												</td>

												<td>
													<?php echo($categoria->precificacao_ativa == 1 ? '<span class="badge badge-success"><i class="fas fa-lock-open"></i>&nbsp;Sim</span>' : ' <span class="badge badge-danger"><i class="fas fa-solid fa-lock"></i>&nbsp;Não</span>'); ?>
												</td>
												...
												<td class="text-right">
													...
													<a data-toggle="tooltip"
													   ...
													   href="<?php echo base_url($this->router->fetch_class() . '/delete/' . $categoria->precificacao_id); ?>"
